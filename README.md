...
This project demonstrates designing and managing a comprehensive library database using SQL.
...
- **Database Creation**: Created a database named `booknest_db`.
...
WHERE member_id IN (SELECT 
                    ...
                    FROM issued_status
                    WHERE 
                        issued_date >= CURRENT_DATE - INTERVAL '3 month'
                    )
;
